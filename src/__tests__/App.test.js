...
import { toBeChecked, toBeInTheDocument } from '@testing-library/jest-dom/matchers'; // Import individual matchers

import App from "../App";

// Use the imported matchers
expect.extend({ toBeChecked, toBeInTheDocument });
